  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/50">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-4xl flex overflow-hidden relative">
        ...
        <div className="w-1/2 p-8 bg-white flex flex-col justify-center relative">
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            ...
            <div className="text-sm">
              <a href="/forgot-password" className="text-blue-900 font-bold hover:underline">
                Forgot Password?
              </a>
            </div>
        ...
        <div className="w-1/2 bg-[#E8967B] text-white p-8 flex flex-col justify-center items-center">
          ...
          <button
            onClick={() => {
              ...
              openJoinModal(); // Open the Join modal
            }}
